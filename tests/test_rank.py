...
class TestComputeKeywordScore:
    ...
    def test_must_terms_give_high_score(self, create_paper, create_topic):
        paper = create_paper(
    ...
    def test_should_terms_add_to_score(self, create_paper, create_topic):
        paper = create_paper(
    ...
    def test_title_match_gives_bonus(self, create_paper, create_topic):
    ...
    def test_exclude_terms_reduce_score(self, create_paper, create_topic):
...
class TestComputeCitationScore:
    ...
    def test_zero_citations_gives_zero_score(self, create_paper):
        paper = create_paper(citation_count=0)
        assert compute_citation_score(paper) == 0.0

    def test_none_citations_gives_zero_score(self, create_paper):
        paper = create_paper(citation_count=None)
        assert compute_citation_score(paper) == 0.0

    def test_more_citations_give_higher_score(self, create_paper):
    ...
    def test_log_scaling_prevents_domination(self, create_paper):
...
class TestComputeVenueScore:
    ...
    def test_boosted_venue_gets_score(self, create_paper, create_topic):
        paper = create_paper(venue="NeurIPS 2024")
        topic = create_topic(venue_boost=["NeurIPS"])
        assert compute_venue_score(paper, topic) > 0

    def test_non_boosted_venue_gets_zero(self, create_paper, create_topic):
    ...
    def test_none_venue_gets_zero(self, create_paper, create_topic):
...
class TestComputeRecencyScore:
    ...
    def test_current_year_gets_highest_score(self, create_paper, create_topic):
    ...
    def test_older_papers_get_lower_score(self, create_paper, create_topic):
        from datetime import date
...
class TestExtractKeyPhrases:
    ...
    def test_extracts_known_keywords(self, create_paper):
        paper = create_paper(
    ...
    def test_returns_empty_for_unrelated_paper(self, create_paper):
        paper = create_paper(
...
class TestSelectWithDiversity:
    ...
    def test_limits_papers_per_phrase(self, create_paper):
    ...
    def test_selects_top_when_diverse(self, create_paper):
        papers = []
...
class TestSelectPapers:
    ...
    def test_selects_requested_number(self, create_paper, create_topic):
    ...
    def test_populates_scores(self, create_paper, create_topic):
    ...
    def test_populates_reason(self, create_paper, create_topic):
        papers = [create_paper(
            title="Imitation learning",
